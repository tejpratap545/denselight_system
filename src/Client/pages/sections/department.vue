            ...
            <v-card class="pt-5" flat>
              ...
              >
                ...
                <v-tooltip v-if="appraisalSelected.status == 'Stage 1'" bottom>
                  ...
                  <span>Add Departmental Goal</span>
                </v-tooltip>
              </v-toolbar>
              <v-card-text>
                <v-data-table
            ...
            <v-card class="pt-5" flat>
              ...
              >
                ...
                <v-tooltip bottom>
                  ...
                  <span>Add Departmental Core Values</span>
                </v-tooltip>
              </v-toolbar>
              <v-card-text>
                <v-data-table
                        ...
                        >
                          <template v-slot:[`item.status`]="{ item }">
                            <v-tooltip bottom>
                              ...
                              <span v-if="item.status == 'Manager'">
                                Manager has to Approve Goals
                              </span>
                              <span v-if="item.status == 'S1BEmployee'">
