    ...
    <div>
        ...
        <div v-else class="ma-5">
            <v-card flat>
                ...
                <v-btn @click="filter" color="primary">
                        ...
                        <v-col>
                            ...
                            <v-row>
                             ...
                             <v-row>
                                ...
                                <v-col>{{ (performance_data.a1 + performance_data.a2 + performance_data.a3 + performance_data.a4 + performance_data.a5) }}</v-col>
                            </v-row>
                        </v-col>
                        <v-col>
                            <BarChart
                    ...
                    <v-row>
                        <v-col>
                            ...
                            <v-row>
                             ...
                             <v-row>
                                <v-col>Grand total</v-col>
                                <v-col>{{ (performance_data.b1 + performance_data.b2 + performance_data.b3 + performance_data.b4 + performance_data.b5) }}</v-col>
                            </v-row>
                        </v-col>
                        <v-col>
                            <BarChart
...
export default {
  ...
  methods: {
    async filter() {
      ...
      const u1 = (this.performance_data.a1 + 
            this.performance_data.a2 + 
            this.performance_data.a3 + 
            this.performance_data.a4 +
            this.performance_data.a5) / 5

      const sd1 = Math.sqrt(( (this.performance_data.a1 - u1)**2 + 
      ...
      const u2 = (this.performance_data.b1 + 
            this.performance_data.b2 + 
            this.performance_data.b3 + 
            this.performance_data.b4 +
            this.performance_data.b5) / 5

      const sd2 = Math.sqrt(( (this.performance_data.b1 - u2)**2 + 
